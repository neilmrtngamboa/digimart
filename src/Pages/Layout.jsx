      ...
      <nav className="flex items-center justify-between flex-wrap bg-blue-950 p-6">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <Link to='about' className="block mt-4 lg:inline-block lg:mt-0 text-yellow-500 hover:text-yellow-600 mr-4">
              About
            </Link>
            <Link to='contact' className="block mt-4 lg:inline-block lg:mt-0 text-yellow-500 hover:text-yellow-600 mr-4">
              Contact
            </Link>
